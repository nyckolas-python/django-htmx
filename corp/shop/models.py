...
class Category(models.Model):
    ...
    slug = models.SlugField(verbose_name='URL', max_length=255, unique=True, null=False, editable=True)
...
class Product(models.Model):
    ...
    brand = models.CharField(verbose_name='Brand', max_length=255, null=False, editable=True)
    description = models.TextField(verbose_name='Description', null=True, blank=True)
    slug = models.SlugField(verbose_name='URL', max_length=255, unique=True, null=False, editable=True)
    price = models.DecimalField(verbose_name='Price', max_digits=10, decimal_places=2, default=99.99)
    image = models.ImageField(verbose_name='Image', upload_to='products/products/%Y/%m/%d', null=True, blank=True)
